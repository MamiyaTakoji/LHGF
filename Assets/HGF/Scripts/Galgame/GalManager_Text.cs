...
namespace ScenesScripts.GalPlot
{
    public class GalManager_Text : MonoBehaviour
    {
        ...
        public virtual void SetText_Content (string TextContent)
        {
        ...
        /// <returns></returns>
        public virtual Tweener StartTextContent (string TextContent, string CharacterName, 
            string TextType, string CharacterIdentity, UnityAction CallBack = null)
        {
            //100  60   40
            void Alwayls ()
            {
            ...
            Alwayls();
            TextAnimateEvemt = Text_TextContent.DOText
                (TextContent, 
                TextContent.Length * (IsFastMode ? FastSpeend : DefalutSpeed))
