...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningSequenceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "JoinCallback", _m_JoinCallback);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_JoinCallback(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    DG.Tweening.TweenCallback _callback = translator.GetDelegate<DG.Tweening.TweenCallback>(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.JoinCallback( _callback );
                        translator.Push(L, gen_ret);
