...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public System.Threading.Tasks.Task __Gen_Delegate_Imp34(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Threading.Tasks.Task<int> __Gen_Delegate_Imp35(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new DG.Tweening.Core.DOSetter<UnityEngine.Vector2>(__Gen_Delegate_Imp15);
			}
			...
			{
			    return new DG.Tweening.Core.DOSetter<float>(__Gen_Delegate_Imp17);
			}
